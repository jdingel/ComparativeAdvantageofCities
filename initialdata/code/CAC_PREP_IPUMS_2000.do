...
cap program drop IPUMS_data_2000
program IPUMS_data_2000
...
quietly infix                  ///
  ...
  str     occsoc      92-97    ///
  str     indnaics    98-105   ///
  byte    wkswork1    106-107  ///
  byte    uhrswork    108-109  ///
  long    inctot      110-116  ///
  long    incwage     117-122  ///
  using `"../input/IPUMS_2000.dat"'
...
compress
desc
label data "IPUMS data for the year 2000"
saveold "../output/IPUMS_data_2000.dta", replace
