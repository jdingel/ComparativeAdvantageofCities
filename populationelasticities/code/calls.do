...
popelasticites_occupations, tabsaveas(tableE2) figsaveas(figure4) figure(1)
popelasticities_industries using "../input/CAC_CBP2000_naics2.dta", tabsaveas(tableE3) figsaveas(figure5) figure(1) naics_digit(2)
